...
<div id="downm">
<div id="zuo">
<div id="gnjs">首页 &gt;&gt; 帮助中心</div>
<div id="hx"></div>


<?php

$sql = "select * from help order by id desc limit 5";
...
?>
<div id="nei">
<div id="bt"><a href="help/?<?php echo $id ?>.html"><?php echo $titles; ?></a></div>
...
<table>
<?php
$sql = "select * from help order by pv limit 9";
$article = mysql_query($sql,$config);
while($new = mysql_fetch_array($article)){
